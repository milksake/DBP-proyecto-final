...
class Product:
    def __init__(
        self, id, name, stars, price, image, description, tags, user=None
    ) -> None:
        self.id = id
...
def search_products(text):
    product_list = []
    for x in products:
        if text.casefold() in x.name.casefold():
            product_list.append(x)
...
add_product(
    ...
    100,
    "imagenes/cubo6.jpeg",
    "El Timur Gear Skewb es un Skewb con engranajes, " +
    "diseñado por Timur Evbatyrov y producido por Calvins.",
    ["2x2", "Gear cubes"],
    users[0],
)
add_product(
    ...
    120,
    "imagenes/cubo7.jpeg",
    "Dayan Wheels of Wisdom es un " +
    "Cubo de 3x3 completamente modificado.",
    ["3x3"],
    users[0],
)
add_product(
...
add_product(
    ...
    90,
    "imagenes/cubo9.jpeg",
    "YJ Floppy Ghost Cuboide 3x3x1 es una versión " +
    "adaptada de los cortes de un Cubo Chost 3x3, " +
    "haciendo que tenga un aforma particulas.",
    ["Mirror cubes"],
    users[0],
)
add_product(
    "Qiyi Cubo Mágico Mirror 2×2",
    5,
    90,
    "imagenes/cubo10.jpeg",
    "Es la variacion del clásico cubo Rubik " +
    "2x2, base negra con stickers color plata.",
    ["2x2", "Mirror cubes"],
    users[0],
)
add_product(
...
add_product(
    ...
    "Serpiente de ShengShou Twist Snake " +
    "blanca. Muchas soluciones y ninguna incorrecta.",
    [],
    users[0],
)
add_product(
